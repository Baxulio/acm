...
#pragma resource "*.dfm"
Tmaincodeforces *maincodeforces;
//---------------------------------------------------------------------------
__fastcall Tmaincodeforces::Tmaincodeforces(TComponent* Owner)
        : TForm(Owner)
{
}
//---------------------------------------------------------------------------

void __fastcall Tmaincodeforces::DBComboBox1Change(TObject *Sender)
...
void __fastcall Tmaincodeforces::CheckBox1Click(TObject *Sender)
{
...
void __fastcall Tmaincodeforces::Image1MouseDown(TObject *Sender,
...
if(Button == mbLeft)
        ...
        ReleaseCapture();
        SendMessage(maincodeforces->Handle, WM_SYSCOMMAND, SC_DRAGMOVE, 0);
        }
}
//---------------------------------------------------------------------------

void __fastcall Tmaincodeforces::Image6Click(TObject *Sender)
{
Close();    
}
//---------------------------------------------------------------------------

void __fastcall Tmaincodeforces::Image6MouseMove(TObject *Sender,
...
void __fastcall Tmaincodeforces::Image1MouseMove(TObject *Sender,
      TShiftState Shift, int X, int Y)
{
...
void __fastcall Tmaincodeforces::Image7Click(TObject *Sender)
{
SendMessage(Handle, WM_SYSCOMMAND, SC_MINIMIZE, 0);
}
//---------------------------------------------------------------------------

void __fastcall Tmaincodeforces::Image7MouseMove(TObject *Sender,
      TShiftState Shift, int X, int Y)
{
Image5->Visible=true;
}
...
void __fastcall Tmaincodeforces::FormCreate(TObject *Sender)
{
